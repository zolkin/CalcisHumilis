...
#include <Arduino.h>
  ...
  #define DBG_GUARD(name, reset_condition)                          \
    ...
    do { if (reset_condition) __dbg_once_##name = false; } while(0)

  #define DBG_GUARDED_PRINTF(name, ...) do {            \
      if (!__dbg_once_##name) {                         \
  ...
  #define DBG_LED_INIT()  do { \
    pinMode(DBG_LED_GREEN, OUTPUT); digitalWrite(DBG_LED_GREEN, LOW); \
    pinMode(DBG_LED_RED, OUTPUT);   digitalWrite(DBG_LED_RED, LOW);   \
  } while(0)
  ...
  #define DBG_LED_INIT()           do{}while(0)
  #define DBG_LED_GREEN_ON()       do{}while(0)
  #define DBG_LED_GREEN_OFF()      do{}while(0)
  #define DBG_LED_GREEN_TOGGLE()   do{}while(0)
  #define DBG_LED_RED_ON()         do{}while(0)
  #define DBG_LED_RED_OFF()        do{}while(0)
  #define DBG_GUARD(...)           do{}while(0)          
  #define DBG_GUARDED_PRINTF(...)  do{}while(0)          
#endif // DEBUG