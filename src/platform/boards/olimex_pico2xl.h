...
struct Board {
  ...
  inline static constexpr SrcPinId TRIG_IN{26};
  inline static constexpr SrcPinId LED_TRIGGER{27};
  inline static constexpr SrcPinId LED_CLIPPING{28};

  // OLED/SPI wiring (SPI0): SCK/MOSI/DC/RST
  inline static constexpr SrcPinId OLED_SCK{6};   // SCK
  inline static constexpr SrcPinId OLED_MOSI{7};  // TX
  inline static constexpr SrcPinId OLED_DC{9};    // D/C
  inline static constexpr SrcPinId OLED_RST{8};   // RESET

  // Front-panel IO as plain GPIO groups (group 0)
  inline static constexpr GroupPinArray<4> LEDS{PinId{0}, PinId{1}, PinId{2},
                                                PinId{3}};
  inline static constexpr GroupPinArray<4> TAB_BUTTONS{PinId{4}, PinId{5},
                                                       PinId{6}, PinId{7}};
  inline static constexpr GroupPinArray<8> ENCODER{
      PinId{8},  PinId{9},  PinId{10}, PinId{11},
      PinId{12}, PinId{13}, PinId{14}, PinId{15}};
